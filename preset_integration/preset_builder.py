...
def build_preset_assets():
    ...
    U_DS_STOCK     = "5518f6ce-d922-4857-8478-41d81a929232"
    ...
    DATASET_UUIDS = {
        ...
        "customs_commodity_details.yaml": U_DS_CUSTOMS_DETAIL,
        "textile_directory.yaml": U_DS_TEXTILE_DIR,
    }
    
    CHART_UUIDS = {
        "interest_rate_bar.yaml":      "5518f6ce-d922-4857-8478-41d81a929121",
        "stock_trend_line.yaml":       "5518f6ce-d922-4857-8478-41d81a929231",
        "customs_trade_mixed.yaml":    "5518f6ce-d922-4857-8478-41d81a929230",
        ...
        "gold_prices_trend_line.yaml": "5518f6ce-d922-4857-8478-41d81a929227",
        "customs_commodity_bar.yaml":  "5518f6ce-d922-4857-8478-41d81a929228",
        "textile_directory_type_bar.yaml": "5518f6ce-d922-4857-8478-41d81a929229",
    }
    ...
    CHART_MAP = {
        ...
        "customs_commodity_bar.yaml": U_DS_CUSTOMS_DETAIL,
        "textile_directory_type_bar.yaml": U_DS_TEXTILE_DIR,
    }
                        ...
                        for k, v in data["position"].items():
                            if k.startswith("CHART-"):
                                ck = {
                                    ...
                                    "CHART-9": "gold_prices_trend_line.yaml",
                                    "CHART-10": "customs_commodity_bar.yaml",
                                    "CHART-11": "textile_directory_type_bar.yaml",
                                }.get(k)
